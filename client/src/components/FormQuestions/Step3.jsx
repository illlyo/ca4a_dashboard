              ...
              <div className="row content">
                <div className="col-md-12">
                  <div className="form-style-10">
                    ...
                    <div className="section"><span>9</span>In general, under which College and Career readiness domain(s) did today's visit fall?</div>
                      ...
                      <div className="section"><span>10</span>Did this school discuss their Learning Trajectory in this meeting?</div>
                        <div className="inner-wrap">
                      ...
                      <div className="section"><span>11</span>To what extent has this school engaged in the following activities?</div>
                      <div className="inner-wrap">
                    ...
                    <div className="section"><span>12</span>What particular tools, protocols, readings, data etc. did you use to help move this team's work forward?</div>
                      <div className="inner-wrap">
                        <div className={notValidClasses.interact_in_these_waysCls}>
